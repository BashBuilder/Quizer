...
function Home() {
  return (
    <div className="h-screen min-h-[600px] py-4 ">
      <Navbar />
      <section className="h-[90%] items-center justify-items-center pt-16 md:grid md:grid-cols-12  md:px-10 md:py-8 ">
        <div className="flex flex-col gap-10 md:col-span-6 md:text-left ">
          <h1 className="text-center leading-[3.5rem] tracking-wider md:w-[25rem] md:text-left ">
